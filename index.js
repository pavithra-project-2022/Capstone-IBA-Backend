...
const uri = `mongodb+srv://pavi:pavi@cluster0.ydkuj.mongodb.net/wearhouse?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const toolsCollection = client.db("wearhouse").collection("tools");
    const reviewsCollection = client.db("wearhouse").collection("reviews");
    const userCollection = client.db("wearhouse").collection("users");
    const orderCollection = client.db("wearhouse").collection("orders");
